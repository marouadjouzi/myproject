...
<body>
    ...
    <section class="home">
     <div class="text"><div class="up" ><h1> Mes recettes</h1>
	 <button id="show" class="show-login"  onclick="tooglePopup()" >Ajouter</button>
	 </div>
       ...
       <div class="titre"><label style="color:#000;"for="titre" >Saisissez le titre :</label>
        <input type="text" id="titre" name="titre"placeholder="Titre...."></div>
        <div class="photo"><label  for="photo">Sélectionnez une photo :</label>
        <input type="file" id="photo" name="photo" ></div>
        <div class="ingredient"><label   for="ingredient">Saisissez les ingredients :</label>
        <div id="ingredient" ><input  type="text" id="ingredients1" id="b" name="ingredients1" placeholder="Ingredient.....">
        <input type="text" id="ingredients2" id="b" name="ingredients2"placeholder="Ingredient....." >
        <input type="text" id="ingredients3" id="b" name="ingredients3"placeholder="Ingredient....." >
        <input type="text" id="ingredients4" id="b" name="ingredients4"placeholder="Ingredient.....">
        <input type="text" id="ingredients5" id="b" name="ingredients5"placeholder="Ingredient.....">
        <input type="text" id="ingredients6" id="b" name="ingredients6"placeholder="Ingredient.....">
        <input type="text" id="ingredients7" id="b" name="ingredients7"placeholder="Ingredient.....">
        <input type="text" id="ingredients8" id="b" name="ingredients8"placeholder="Ingredient.....">
        <input type="text" id="ingredients9" id="b" name="ingredients9"placeholder="Ingredient.....">
        <input type="text" id="ingredients10"id="b"name="ingredients10"placeholder="Ingredient....."></div></div>
        <br>
         
        <div class="preparation"><label for="preparation">Saisissez la methode de preparation :</label><br>
        <textarea id="preparation" name="preparation" rows="30" cols="47" placeholder="Preparation...."></textarea></div>

        <div class="envoie" id="submit">
                <input type="submit" value="Ajouter" name="Ajouter"  style="background:#b715d6;color:#fff;font-size:15px;"></div>
       </div>
    </div>
    ...
    <?php foreach($result as $row) {  ?> 
      ...
      <h2 style="color:#9f2aa1; font-size:40px;"><?php  echo  $row['valeurTitre'];?></h2>
        <p><div class="p" style="font-size: 20px; text-decoration:underline;"><div style="font-size: 30px;">Ingredients:</div></div><br><?php
        ...
        <br><br><p><div class="p" style="font-size: 20px; text-decoration:underline;"><div style="font-size: 30px;"> Preparation:</div></div><br>
<?php echo  $row['valeurPreparation'] ;?> </p> <br>
    <div class="btnn" style="display:flex;"><form action="planner.php" method="post">
    <input type="hidden" name="id" value="' <?php echo $row['id']; ?> '">
    <input type="submit" name="supprimer" class="supprimer" value="Supprimer" style="background: #b715d6;border:none;
    color:#fff;
    font-size:20px;
    padding:5px 10px;
    ...
    <div class="popup1" id="popup1">
       ...
       <div class="titre"><label style="color:#000;"for="titre1" >Saisissez le titre :</label>
        <input type="text" id="titre1" name="titre1"placeholder="Titre...."></div>
        <br>
        

         
        <div class="ingredient"><label   for="ingredient">Saisissez les ingredients :</label><br>
        <div id="ingredient1" ><input  type="text" id="ingredients11" id="b" name="ingredients11" placeholder="Ingredient.....">
        <input type="text" id="ingredients21" id="b" name="ingredients21"placeholder="Ingredient....." >
        <input type="text" id="ingredients31" id="b" name="ingredients31"placeholder="Ingredient....." >
        <input type="text" id="ingredients41" id="b" name="ingredients41"placeholder="Ingredient.....">
        <input type="text" id="ingredients51" id="b" name="ingredients51"placeholder="Ingredient.....">
        <input type="text" id="ingredients61" id="b" name="ingredients61"placeholder="Ingredient.....">
        <input type="text" id="ingredients71" id="b" name="ingredients71"placeholder="Ingredient.....">
        <input type="text" id="ingredients81" id="b" name="ingredients81"placeholder="Ingredient.....">
        <input type="text" id="ingredients91" id="b" name="ingredients91"placeholder="Ingredient.....">
        <input type="text" id="ingredients101"id="b"name="ingredients101"placeholder="Ingredient....."></div></div>
        <br>
         
        <div class="preparation"><label for="preparation1">Saisissez la methode de preparation :</label><br>
        <textarea id="preparation1" name="preparation1" rows="30" cols="47" placeholder="Preparation...."></textarea></div>
              
              <div class="envoie" id="submit">
                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                <input type="submit" value="Modifier" name="Modifier"  style="background:#b715d6;color:#fff;font-size:15px;"></div>
       </div>
            </form></div></div>
     </div><?php
      }
