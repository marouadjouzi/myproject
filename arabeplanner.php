...
<body>
    ...
    <section class="home">
     <div class="text"><div class="up" ><h1>وصفاتي</h1>
       <button id="show" class="show-login"  onclick="tooglePopup()" >اضافة</button>
       ...
       <div class="titre"><label style="color:#000;"for="titre" >ضع العنوان:</label>
        <input type="text" id="titre" name="titre"placeholder="العنوان...."></div>
        <br>
        <div class="photo"><label  for="photo">ضع صورة:</label>
        <input type="file" id="photo" name="photo" ></div>
        <br>

         
        <div class="ingredient"><label   for="ingredient">ضع المقادير:</label><br>
        ...
        <div class="preparation"><label for="preparation">ضع طريقة التحضير:</label><br>
        <textarea id="preparation" name="preparation" rows="30" cols="47" placeholder="الطريقة...."></textarea></div>

        <div class="envoie" id="submit">
                <input type="submit" value="اضافة" name="Ajouter"  style="background:#b715d6;color:#fff;font-size:15px;"></div>
       </div>
    </div>
